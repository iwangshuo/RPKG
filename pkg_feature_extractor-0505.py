...
class FeatureExtractor:
    def __init__(self):
        ...
        self.pkg_name_feature_path = os.path.join(cur_dir, 'output/pkg_name_feature-20230505.csv')
        self.pkg_name_other_feature_path = os.path.join(cur_dir, 'output/pkg_name_other_feature-20230505.csv')
        self.feature_entity_dict_path = os.path.join(cur_dir, 'output/feature_entity_dict.csv')
        # 领域名词（机器人名字、传感器名字等）
